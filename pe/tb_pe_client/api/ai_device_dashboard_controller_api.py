...
class AiDeviceDashboardControllerApi:
    ...
    def generate_dashboard(
        ...
        _param = self._generate_dashboard_serialize(
            device_id=device_id,
    ...
    @validate_call
    def generate_dashboard_with_http_info(
        self,
        device_id: UUID,
        x_authorization: StrictStr,
        body: Optional[Any],
    ...
    @validate_call
    def generate_dashboard_without_preload_content(
        self,
        device_id: UUID,
        x_authorization: StrictStr,
        body: Optional[Any],
    ...
    def _generate_dashboard_serialize(
        self,
        device_id,
        x_authorization,
        body,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/ai/devices/{deviceId}/dashboard',
