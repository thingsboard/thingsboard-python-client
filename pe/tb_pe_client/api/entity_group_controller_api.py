...
class EntityGroupControllerApi:
    ...
    def share_entity_group_to_child_owner_user_group(
        self,
        entity_group_id: Annotated[StrictStr, Field(description="ID of the entity group to share")],
        user_group_id: Annotated[StrictStr, Field(description="ID of the user group to share the entity group with. The user group must belong to the current user's owner or to one of its sub-customers")],
        role_id: Annotated[StrictStr, Field(description="ID of the group role that defines the set of operations to grant to the target user group")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param entity_group_id: ID of the entity group to share (required)
        :type entity_group_id: str
        :param user_group_id: ID of the user group to share the entity group with. The user group must belong to the current user's owner or to one of its sub-customers (required)
        :type user_group_id: str
        :param role_id: ID of the group role that defines the set of operations to grant to the target user group (required)
        :type role_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
