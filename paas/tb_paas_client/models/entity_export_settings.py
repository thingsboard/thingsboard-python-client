...
class EntityExportSettings(BaseModel):
    """
    EntityExportSettings
    """ # noqa: E501
    export_relations: Optional[StrictBool] = Field(default=None, serialization_alias="exportRelations")
    export_attributes: Optional[StrictBool] = Field(default=None, serialization_alias="exportAttributes")
    export_credentials: Optional[StrictBool] = Field(default=None, serialization_alias="exportCredentials")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityExportSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityExportSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "export_relations": obj.get("exportRelations"),
            "export_attributes": obj.get("exportAttributes"),
