...
class CloudDomainInfo(BaseModel):
    """
    CloudDomainInfo
    """ # noqa: E501
    id: Optional[CloudDomainId] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "customerId", "domainName", "acmeCertificateId", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudDomainInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudDomainInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": CloudDomainId.from_dict(obj["id"]) if obj.get("id") is not None else None,
