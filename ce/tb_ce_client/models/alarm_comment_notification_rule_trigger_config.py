...
class AlarmCommentNotificationRuleTriggerConfig(NotificationRuleTriggerConfig):
    ...
    """ # noqa: E501
    trigger_type: NotificationRuleTriggerType = Field(default=NotificationRuleTriggerType.ALARM_COMMENT, serialization_alias="triggerType")  # post_process: discriminator default
