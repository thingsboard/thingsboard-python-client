...
class TaskProcessingFailureNotificationRuleTriggerConfig(NotificationRuleTriggerConfig):
    ...
    """ # noqa: E501
    trigger_type: NotificationRuleTriggerType = Field(default=NotificationRuleTriggerType.TASK_PROCESSING_FAILURE, serialization_alias="triggerType")  # post_process: discriminator default
